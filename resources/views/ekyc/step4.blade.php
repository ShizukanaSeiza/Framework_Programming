           ...
           {{-- Kecamatan --}}
            ...
            <div class="mb-6">
                ...
                <select name="referensi_sumber" class="mt-1 block w-full border-gray-300 rounded-md">
                    ...
                    <option value="Teman/ Keluarga" {{ old('referensi_sumber', $data->referensi_sumber) == 'Teman/ Keluarga' ? 'selected' : '' }}>Teman/ Keluarga</option>
            ...
            <div class="flex justify-between items-center mt-4">
                ...
                <button type="submit"
                    class="px-4 py-2 bg-gray-400 text-white rounded-md cursor-not-allowed" disabled>
            ...
            <script>
                ...
                document.getElementById('kota').addEventListener('change', function() {
                    ...
                    const filteredKecamatan = alamatData.filter(item => item.kota === kota);
                    filteredKecamatan.forEach(item => {
